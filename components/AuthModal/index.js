...
const resetPassword = () => {
  ...
  return (
    ...
    <>
        ...
        <a style={{textDecoration: 'none', width: '100%'}} onClick={() => setIsGithubProcessing(true)} href="/api/auth/oauth/google">
          <GithubLoadingButton  loading={isGithubProcessing} startIcon={<GoogleIcon/>} sx={{width: "100%", p: '0.65rem'}}>Sign in with Google</GithubLoadingButton>
        </a>
